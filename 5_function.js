...
// function greet() {
//   console.log("Hello Guys, Welcome to Satyam JS Course ");
// }
...
//! Write a JavaScript program that defines a function called greet to welcome individuals to the Satyam CHauhan JS Course. The function should take a name parameter and output the message "Hello [name], Welcome to satyam Technical JS Course". Call the function twice, once with the argument "satyam" and once with the argument "ram".
// function greet(name) {
//   console.log("Hello " + name + ", Welcome to Satyam Chauhan JS Course");
// }
